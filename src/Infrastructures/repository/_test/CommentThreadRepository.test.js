...
describe('CommentThreadRepositoryPostgres', () => {
  ...
  describe('verifyAvailableCommentThread function', () => {
    ...
    describe('verifyAccessUserComment function', () => {
      it('should throw AuthorizationError when users can not access comment', async () => {
        ...
        // assert
        await expect(commentThreadRepositoryPostgres.verifyAccessCommentThread('comment-comment123', 'user-user13')).rejects.toThrowError(AuthorizationError);
      });
      ...
      it('should not throw AuthorizationError when users can access comments', async () => {
        ...
        // assert
        await expect(commentThreadRepositoryPostgres.verifyAccessCommentThread('comment-comment123', 'user-user123')).resolves.not.toThrowError(AuthorizationError);
      });
    });
  });
});
